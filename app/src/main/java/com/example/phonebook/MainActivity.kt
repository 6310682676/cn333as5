...
import com.example.phonebook.ui.theme.MyPhoneBookTheme
import com.example.phonebook.ui.theme.MyPhonesThemeSettings
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MyPhoneBookTheme(darkTheme = MyPhonesThemeSettings.isDarkThemeEnabled) {
...
fun MainActivityScreen(viewModel: MainViewModel) {
    Surface {
        when (MyPhonesRouter.currentScreen) {
            ...
            is Screen.SavePhone -> SaveContactScreen(viewModel)
